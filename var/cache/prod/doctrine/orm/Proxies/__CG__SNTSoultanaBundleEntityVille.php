 ...
 */
class Ville extends \SNT\SoultanaBundle\Entity\Ville implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'SNT\\SoultanaBundle\\Entity\\Ville' . "\0" . 'idVille', '' . "\0" . 'SNT\\SoultanaBundle\\Entity\\Ville' . "\0" . 'nomVille'];
        }
